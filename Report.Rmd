...
### Data Visualization  
Now we can start visualizing the data. These are the graphs for values in each column just to understand the range and spread of in each column. Graphs other than Age and Gender contains a vertical line to show the avergae value in the column.  
...
```{r glm, echo=FALSE, message=FALSE}
